    ...
    <div class="row">
        <div class="col-10 offset-1">
            <p class="text-left" style="font-size: 20px;"><br>Founded in 2017, Kelly' Computer Service is a provider of&nbsp;<strong>IT consulting</strong>&nbsp;and&nbsp;<strong>software development services</strong>. Having started as a small AI product company, we switched to IT services in 2002
                and ever since we have helped non-IT organizations and software product companies improve business performance and quickly win new customers.<br><br></p><img class="rounded-circle img-fluid shadow-lg" data-bs-hover-animate="swing" src="assets/img/homepageimage.jpg"
                width="1000px" height="50ox"></div>
    </div>
    <div class="row">
        <div class="col"></div>
    </div>
        ...
        <div class="container">
            ...
            <div class="row projects">
                <div class="col-sm-6 item">
                    <div class="row">
                        <div class="col-md-12 col-lg-5">
                            <a href="#"><img class="rounded-circle img-fluid shadow-lg" src="assets/img/kelly.png"></a>
                        </div>
                        <div class="col">
                ...
                <div class="col-sm-6 item">
                    <div class="row">
                        <div class="col-md-12 col-lg-5">
                            <a href="#"><img class="rounded-circle img-fluid shadow-lg" src="assets/img/gillian.jpg" width="200px" height="100px"></a>
                        </div>
                        <div class="col">
                ...
                <div class="col-sm-6 item">
                    <div class="row">
                        <div class="col-md-12 col-lg-5">
                            <a href="#"><img class="rounded-circle img-fluid shadow-lg" src="assets/img/yanick.jpg" width="200px"></a>
                        </div>
                        <div class="col">
                ...
                <div class="col-sm-6 item">
                    <div class="row">
                        <div class="col-md-12 col-lg-5">
                            <a href="#"><img class="rounded-circle img-fluid shadow-lg" src="assets/img/Rev.jpg"></a>
                        </div>
                        <div class="col">
