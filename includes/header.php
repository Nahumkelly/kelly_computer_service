                    ...
                    <div class="collapse navbar-collapse" id="navcol-2">
                        <ul class="nav navbar-nav nav-right">
                            ...
                            <li class="nav-item dropdown"><a class="dropdown-toggle nav-link <?php if($page == "dropdown"){echo 'active';}?>" data-toggle="dropdown" aria-expanded="false" href="#" style="/*color: rgba(251,2,2,0.9);*/text-align: center;font-family: 'Roboto Slab', serif;/*font-size: 21px;*//*border-width: 4px;*//*box-shadow: inset 5px 5px 5px 5px rgba(7,2,251,0.9);*//*text-shadow: 2px 2px 3px rgba(252,251,251,0.9);*//*background: rgb(252,252,252);*/">Services </a>
                                ...
                                <a class="dropdown-item " href="manage.php" style="color: rgb(251,1,1);">Managed IT Services</a>
                            ...
                            <li class="nav-item"><a class="nav-link <?php if($page == "aboutus"){echo 'active';}?>" href="privacy.php" style="/*color: rgba(251,2,2,0.9);*/text-align: center;font-family: 'Roboto Slab', serif;/*font-size: 21px;*//*border-width: 4px;*//*box-shadow: inset 5px 5px 5px 5px rgba(7,2,251,0.9);*//*text-shadow: 2px 2px 3px rgba(252,251,251,0.9);*//*background: rgb(252,252,252);*/">About djdjdjjd </a></li>
                            <li class="nav-item"><a class="nav-link <?php if($page == "policy"){echo 'active';}?>" href="privacy.php" style="/*color: rgba(251,2,2,0.9);*/text-align: center;font-family: 'Roboto Slab', serif;/*font-size: 21px;*//*border-width: 4px;*//*box-shadow: inset 5px 5px 5px 5px rgba(7,2,251,0.9);*//*text-shadow: 2px 2px 3px rgba(252,251,251,0.9);*//*background: rgb(252,252,252);*/">Privacy Policy<br></a></li>
